...
export default function Home() {
  ...
  return (
    <div className="home bg-effect">
        ...
        <div className="section-1">
          ...
          <div className="w-full flex flex-col items-center">
            <h1 className="font-black text-center">
              Welcome! <span className="text-[3rem]"> أهلا</span>
            </h1>
            <h2 className="font-black text-center text-indigo-400">
              Ready to be Active ?{" "}
            </h2>
            <h2 className="font-black text-center text-[2rem] py-[2em]">
              Bored from being <span className="text-indigo-400">alone</span>?
              make new <span className="text-indigo-400">Friends</span> Now !
            </h2>
            <button
              className="w-[20%] py-[1em] bg-indigo-600 hover:bg-white hover:text-black transition"
              onClick={() =>
            ...
            <div className="about flex flex-col">
              ...
              <div className="steps px-[6em] my-[2.5em] flex justify-between w-[50%] mx-auto bg-indigo-500 py-[1em] rounded">
      ...
      <Element name="home2" className="bg-[#050816] home2">
        <div className="container m-auto flex flex-col justify-between h-[70%]">
          ...
          <h3 className="text-center text-3xl font-black my-[2em]">
            ...
            dreams." -{" "}
            <span className="text-indigo-400">Eleanor Roosevelt</span>
          </h3>
          <div className="flex justify-between py-[2em]">
